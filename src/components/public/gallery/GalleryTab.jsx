...
export default function GalleryTab() {
  ...
  const galleryData = {
    ...
    subtitle: "আমাদের অনলাইন লাইভ ক্লাস, বিভিন্ন কুইজ প্রতিযোগিতা, ভার্চুয়াল সেমিনার ও অনলাইন শিক্ষামূলক ভিডিওর সংকলন",
    photos: [
      { id: 1, title: "আমাদের লার্নিং পোর্টাল ইন্টারফেস", tag: "অনলাইন ক্যাম্পাস" },
      ...
      { id: 6, title: "সমৃদ্ধ ডিজিটাল লাইব্রেরি ও ই-বুক পোর্টাল", tag: "অনলাইন ক্যাম্পাস" }
    ],
    videos: [
