...
export default function Profile({ data }) {
  ...
  const fallbackData = {
    ...
    description: "আমাদের অনলাইন লার্নিং প্ল্যাটফর্মটি পবিত্র কুরআনুল কারীমের হিফজ এবং জেনারেল শিক্ষার এক অপূর্ব সমন্বয় ঘটিয়ে বিশ্বজুড়ে দ্বীনি শিক্ষা পৌঁছে দিচ্ছে। আমরা আধুনিক ভার্চুয়াল ক্লাসরুম, লাইভ ইন্টারেক্টিভ সেশন এবং দক্ষ মেন্টরশিপের মাধ্যমে শিক্ষার্থীদের নৈতিকতা, তাকওয়া ও সুন্নাহর আলোয় আলোকিত মানুষ হিসেবে গড়ে তুলছি।",
    hadithQuote: "তোমাদের মধ্যে সেই ব্যক্তি সর্বোত্তম, যে নিজে কুরআন শিক্ষা করে এবং অন্যকে তা শিক্ষা দেয়। — আল হাদিস",
    ...
    facts: [
      ...
      { label: "লার্নিং মাধ্যম", value: "১০০% অনলাইন (লাইভ ও রেকর্ডেড)" }
    ]
  };
