...
export default function Features({ data }) {
  const fallbackData = {
    ...
    items: [
      ...
      { id: 3, icon: "🛡️", title: "ভার্চুয়াল লার্নিং ক্যাম্পাস", desc: "বিশ্বের যেকোনো প্রান্ত থেকে যেকোনো সময় যুক্ত হওয়ার জন্য সম্পূর্ণ ক্লাউড-ভিত্তিক সুরক্ষিত শিক্ষা পরিবেশ।" },
      { id: 4, icon: "💬", title: "১-অন-১ মেন্টরিং ও সাপোর্ট", desc: "কঠিন বিষয়গুলো সহজে বুঝার জন্য নিয়মিত ডেডিকেটেড ১-অন-১ ওস্তাদ সাপোর্ট সেশন ও ডাউট সলভিং।" }
    ]
  };
