...
export default function Staff({ data }) {
  const fallbackData = {
    ...
    list: [
      ...
      { id: 2, name: "জনাব মো: আব্দুল করিম", role: "অনলাইন সাপোর্ট কো-অর্ডিনেটর", contact: "018XXXXXXXX" },
      { id: 3, name: "জনাব মো: সোলায়মান", role: "আইটি সাপোর্ট অ্যাসিস্ট্যান্ট", contact: "নন-পাবলিক" }
    ]
  };
