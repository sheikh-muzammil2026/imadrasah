...
export default function WhyChooseUs() {
    const features = [
        ...
        {
            icon: "💻",
            title: "ফ্লেক্সিবল ও ইন্টারেক্টিভ লার্নিং",
            description: "বিশ্বের যেকোনো প্রান্ত থেকে লাইভ ক্লাসে অংশগ্রহণ এবং সুবিধাজনক সময়ে রেকর্ডেড ক্লাস দেখার অনন্য সুযোগ।",
        },
        {
            icon: "👨‍🏫",
