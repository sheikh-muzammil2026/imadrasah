    ...
    const reviews = [
        {
            ...
            rating: "⭐⭐⭐⭐⭐",
            comment: "অনলাইন আইডিয়াল মাদ্রাসার দ্বীনি ও আধুনিক শিক্ষার সমন্বয়টি চমৎকার। বিশেষ করে শিক্ষার্থীদের আখলাক এবং সুন্নতি জিন্দেগি গঠনের প্রতি শিক্ষকদের আন্তরিকতা সত্যিই প্রশংসনীয়।"
        },
        {
