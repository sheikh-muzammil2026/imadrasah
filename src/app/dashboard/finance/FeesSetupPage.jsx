...
export default function FeesSetupPage() {
  ...
  const incomeCategories = [
    ...
    { value: "boarding_fee", label: "অনলাইন পোর্টাল সাবস্ক্রিপশন ফি" },
    ...
    { value: "day_care", label: "অনলাইন লাইভ ক্লাস ও মেন্টরিং" },
    { value: "coaching_fee", label: "কোর্স/কোচিং" },
    { value: "dress_fee", label: "অনলাইন রিসোর্স / ডিজিটাল কন্টেন্ট" },
    { value: "stationery_kit", label: "ডিজিটাল কিতাব / ই-বুক / আইডি কার্ড" },
