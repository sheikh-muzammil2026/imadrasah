...
export async function POST(req) {
  try {
    ...
    const madrasahContext = `
      তুমি হলে "অনলাইন আইডিয়াল মাদ্রাসা, ঢাকা, বাংলাদেশ" এর কৃত্রিম বুদ্ধিমত্তা সহকারী।
      ...
      উত্তর সংক্ষিপ্ত ও বাংলায় দেবে। মাদরাসার বাইরে কোনো ফালতু বা রাজনৈতিক প্রশ্নের উত্তর দেবে না। "ইসলামিক অভিবাদন (আস-সালামু আলাইকুম)" প্রথমবার রিপ্লাই দেয়ার পর বলবেন। পরের সকল রিপ্লাইয়ে আর "আস-সালামু আলাইকুম" বলবেন না। 
    `;
